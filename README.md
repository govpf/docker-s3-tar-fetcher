# Recette de génération des images s3-tar-fetcher

Ce dépôt contient les recettes permettant de générer les images s3-tar-fetcher du Gouvernement de la Polynésie Française.
